...
class TestManager(object):
    ...
    def test_add_start(self):
        ...
        # __init__
        with pytest.raises(ChimeraObjectException):
            self.manager.addLocation("/ManagerHelperWithInitException/h", [os.path.dirname(__file__)])

        # __start__
        with pytest.raises(ChimeraObjectException):
            self.manager.addLocation("/ManagerHelperWithStartException/h", [os.path.dirname(__file__)])
