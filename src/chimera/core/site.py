...
class Site(ChimeraObject):
    ...
    def sun_azimuth(self, date=None):
        """
        Sun azimuth in DEGREES, measured from North through East.

        The anti-solar azimuth, sun_azimuth() + 180, is where the twilight
        sky gradient is smallest - where sky flats want to point.
