...
class DomeBase(ChimeraObject, DomeSlew, DomeSlit, DomeFlap, DomeSync):
    ...
    def __start__(self):
        ...
        if tel:
            ...
            self.log.warning(
                "Couldn't find telescope. Telescope events would" " not be monitored. Dome will stay in Stand mode."
            )
    ...
    def control(self):
        ...
        try:
            ...
            raise ChimeraException("Couldn't found the selected telescope." " Dome cannnot track.")
