...
class TelescopeTest(object):
    ...
    def assertEvents(self, slewStatus):
        ...
        assert (
            isinstance(FiredEvents["slewComplete"][2], EnumValue) and FiredEvents["slewComplete"][2] in TelescopeStatus
        )
    ...
    def test_jog(self):
        ...
        print(
            "North:", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )

        start = self.tel.getPositionRaDec()
        self.tel.moveSouth(dt, SlewRate.FIND)
        print(
            "South:", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )

        start = self.tel.getPositionRaDec()
        self.tel.moveWest(dt, SlewRate.FIND)
        print(
            "West :", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )

        start = self.tel.getPositionRaDec()
        self.tel.moveEast(dt, SlewRate.FIND)
        print(
            "East :", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )
        ...
        self.tel.moveEast(dt, SlewRate.FIND)
        print(
            "NE   :", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )
        ...
        self.tel.moveEast(dt, SlewRate.FIND)
        print(
            "SE   :", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )
        ...
        self.tel.moveWest(dt, SlewRate.FIND)
        print(
            "NW   :", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )
        ...
        self.tel.moveWest(dt, SlewRate.FIND)
        print(
            "SW   :", (start.ra - self.tel.getPositionRaDec().ra).AS, (start.dec - self.tel.getPositionRaDec().dec).AS
        )
...
class TestFakeTelescope(FakeHardwareTest, TelescopeTest):
    ...
    def setup(self):
        ...
        self.manager.addClass(
            Site, "lna", {"name": "UFSC", "latitude": "-27 36 13 ", "longitude": "-48 31 20", "altitude": "20"}
        )
