...
class DomeTest(object):
    ...
    def assertEvents(self, slewStatus=None, sync=False):
        ...
        if slewStatus:
            ...
            assert (
                isinstance(FiredEvents["slewComplete"][2], EnumValue) and FiredEvents["slewComplete"][2] in DomeStatus
            )
...
class TestFakeDome(FakeHardwareTest, DomeTest):
    ...
    def setup(self):
        ...
        self.manager.addClass(FakeDome, "dome", {"telescope": "/FakeTelescope/0", "mode": "Track"})
...
class TestRealDome(RealHardwareTest, DomeTest):
    ...
    def setup(self):
        ...
        self.manager.addClass(DomeLNA40cm, "lna40", {"device": "/dev/ttyS9", "telescope": "/Meade/0", "mode": "Stand"})
