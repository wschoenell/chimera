...
from chimera.core.constants import MANAGER_DEFAULT_HOST, MANAGER_DEFAULT_PORT, SYSTEM_CONFIG_DEFAULT_FILENAME
...
class SiteController(object):
    ...
    def parseArgs(self, args):
        ...
        config_group.add_option(
            "--config", dest="config_file", help="Start Chimera using configuration from FILE.", metavar="FILE"
        )
